...
public class Player : Actor
{
	...
	//			typeof(DetectionArea).ToString(),
	//			typeof(DetectionArea)
	//			);
	...
	//		//SelfTransform.position += pos * Time.deltaTime;

	//		Vector2 Axis = Stick.Axis;
	//		Vector3 MovePosition = transform.position;
	//		MovePosition += new Vector3(Axis.x, 0, Axis.y);
	//		this.SelfComponent<NavMeshAgent>()
	...
	//		case "AttackEnd":
	//			{
	//				ChangeState((eStateType)datas[0]);
	//			}
	//			break;
